          ...
          <View style={styles.body}>
                  ...
                  {pending.map((item) => (
                    <View key={item.conferenceUid} style={styles.pendingRow}>
                      <View style={styles.pendingInfo}>
                        ...
                        >
                          {item.trainerName ?? "Unknown Trainer"} •{" "}
                          {item.conferenceDate ?? "--"}{" "}
                          {item.conferenceTime ?? ""}
                        </AppText>
                      </View>
                      {actioningUid === item.conferenceUid ? (
                        ...
                        <View style={styles.pendingActions}>
                          <Pressable
                            ...
                            onPress={() => handleReject(item.conferenceUid)}
                          >
                            <Ionicons
                              name="close"
                              size={16}
                          ...
                          <Pressable
                            ...
                            onPress={() => handleApprove(item.conferenceUid)}
                          >
                            <Ionicons
                              name="checkmark"
                              size={16}
            ...
            <View style={styles.card}>
              <View style={styles.cardHeaderRow}>
                ...
                <Pressable
                  style={styles.addSuiteButton}
                  onPress={() => router.push("/assessment_builder")}
                >
                  <Ionicons name="add" size={16} color={Colors.white} />
                  <AppText
                    style={styles.addSuiteButtonText}
                    color={Colors.white}
                ...
                <View style={styles.suiteList}>
                  {suites.map((suite) => (
                    <Pressable
                      ...
                      onPress={() =>
                        router.push({
                          pathname: "/assessment_builder",
                          params: { suiteUid: suite.assessmentSuiteUid },
                        })
                      }
                    >
                      ...
                      <View style={styles.suiteInfo}>
                        <AppText
                          style={styles.suiteName}
                          weight={FontWeight.medium}
                        >
                          {suite.name}
                        </AppText>
                        <AppText
                          style={styles.suiteMeta}
                          color={Colors.gray600}
                        >
