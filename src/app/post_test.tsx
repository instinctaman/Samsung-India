    ...
    try {
      ...
      setError(
        err instanceof ApiError
          ? err.message
          : "Couldn't load the test questions.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <View style={styles.timerProctorRow}>
          ...
          <View style={styles.proctorColumn}>
            <ProctoringPanel
              token={token}
              active={!submitting}
              onMaxWarnings={handleSubmit}
            />
          </View>
        </View>
        <View style={styles.testTitle}>
          <AppText style={styles.title} weight={FontWeight.medium}>
            Standard Test
          </AppText>
        </View>
        <View style={styles.questionCard}>
          <View style={styles.tags}>
            <AppText style={styles.questionTag} color={Colors.primary}>
              Question {questionIndex + 1} of {questions.length}
            </AppText>
            <AppText style={styles.multiTag}>Single Select</AppText>
          </View>
          ...
          <View style={styles.actions}>
            <Pressable
              ...
              style={[
                ...
                questionIndex === 0 && styles.disabledButton,
              ]}
            >
...
const styles = StyleSheet.create({
  ...
  timerProctorRow: { flexDirection: "row", gap: 10, alignItems: "center" },
  proctorColumn: { flex: 1 },
  testTitle: {
    borderRadius: 9,
    backgroundColor: Colors.white,
    padding: 12,
  ...
  title: { fontSize: Fonts.h3, textAlign: "center", lineHeight: 23 },
  questionCard: {
    borderRadius: 9,
    borderWidth: 1,
    borderColor: "#9AD2FF",
  ...
  question: { marginTop: 10, fontSize: Fonts.body, lineHeight: 19 },
  ...
  optionSelected: { borderColor: Colors.primary, backgroundColor: "#EEF5FF" },
  checkbox: {
    width: 15,
    height: 15,
    borderWidth: 1,
  ...
  optionText: { flex: 1, fontSize: Fonts.caption },
  ...
  previousText: { color: Colors.primary, fontWeight: FontWeight.semiBold },
