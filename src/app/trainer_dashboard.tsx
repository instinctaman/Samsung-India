...
// Preserved alternate wiring from the upstream/Tushar merge — same dashboard, sourced
// from the useTrainerDashboard hook (adds an accountOpen/AccountPanel drawer and a
// SidebarMenu instead of TrainerMoreMenu) instead of this file's own local state.
// TrainerDashboardScreen above is the active route; this is kept intact rather than
// deleted since the hook, SidebarMenu, and AccountPanel it relies on shouldn't be lost.
function TrainerDashboardScreenViaHook() {
  const router = useRouter();
