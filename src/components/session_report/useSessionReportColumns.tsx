...
import { SessionReportParticipant } from "@/data/mockData";
...
export function useSessionReportColumns(): DataTableColumn<SessionReportParticipant>[] {
  return [
    ...
    { key: "checkIn", header: "Check In", minWidth: 60, exportValue: (row) => row.checkIn },
    { key: "checkOut", header: "Check Out", minWidth: 62, exportValue: (row) => row.checkOut },
    { key: "score", header: "Score", minWidth: 46, exportValue: (row) => row.score },
  ];
}
