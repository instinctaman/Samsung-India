...
export const DEMO_TRAINEE = {
  ...
  name: "Anshu Pandey",
  phone: 9987898789 as number,
  email: "anshu.pandey@samsung.com",
  gender: "male" as string | null,
  designation: "COORDINATOR" as string | null,
  employee_id: null as string | null,
  supervisorName: "AKASH ROY" as string | null,
...
const _realTraineeSeed: Partial<NewTraineeRecord>[] = [
  { traineeUid: "TRN26081914223765", fullName: "Kevil Panchal", primaryPhone: "9925413104", trainerName: "", supervisorName: "Bipin prajapati", district: "Ahmedabad", state: "Gujarat", timestamp: "2026-08-19 14:22:37" },
  { traineeUid: "TRN26081914172934", fullName: "Prince", primaryPhone: "9350393292", trainerName: "", supervisorName: "Harjeet", district: "Fatehabad", state: "Haryana", timestamp: "2026-08-19 14:17:29" },
  { traineeUid: "TRN26081914060237", fullName: "Maheshsingh chand", primaryPhone: "8000852006", trainerName: "", supervisorName: "AHTESAM SIR", district: "Vapi", state: "Gujarat", timestamp: "2026-08-19 14:06:02" },
  { traineeUid: "TRN26081914054617", fullName: "Khushbu", primaryPhone: "7698217549", trainerName: "", supervisorName: "Mahesh chand", district: "Vapi", state: "Gujarat", timestamp: "2026-08-19 14:05:46" },
  { traineeUid: "TRN26081914035127", fullName: "Uwais pathan", primaryPhone: "9054985127", trainerName: "", supervisorName: "Maheah Chand", district: "Vapi", state: "Gujarat", timestamp: "2026-08-19 14:03:51" },
  { traineeUid: "TRN26081914014493", fullName: "VIVEK SIngh", primaryPhone: "9104068023", trainerName: "", supervisorName: "Mahesh chand", district: "Vapi", state: "Gujarat", timestamp: "2026-08-19 14:01:44" },
  { traineeUid: "TRN26081912410825", fullName: "Komal", primaryPhone: "6399897617", trainerName: "", supervisorName: "Pankaj kumar", district: "Dehradun", state: "Uttarakhand", timestamp: "2026-08-19 12:41:08" },
  { traineeUid: "TRN26081912325891", fullName: "Nihal Anand", primaryPhone: "7992210715", trainerName: "", supervisorName: "Manoj Bisht", district: "Gurgaon Training Centre", state: "Haryana", timestamp: "2026-08-19 12:32:58" },
  { traineeUid: "TRN26081912303393", fullName: "Deependra Meena", primaryPhone: "7300059090", trainerName: "", supervisorName: "Manoj Bisht", district: "Gurgaon Training Centre", state: "Haryana", timestamp: "2026-08-19 12:30:33" },
];

const TRAINEE_LIST_TOTAL = 159;

export const DEMO_REGISTERED_TRAINEES: NewTraineeRecord[] = [
  ..._realTraineeSeed.map((overrides, i) => _makeDemoTrainee(i, overrides.fullName!, "Approved", overrides)),
  ...Array.from({ length: TRAINEE_LIST_TOTAL - _realTraineeSeed.length }, (_, i) => {
    const seed = _seedTraineeNames[i % _seedTraineeNames.length];
    return _makeDemoTrainee(_realTraineeSeed.length + i, seed.name, seed.approvalStatus);
  }),
];
...
export const DEMO_AGENDA: DemoAgendaItem[] = [
  {
    conferenceUid: "CONF2608R7", title: "Classroom Training – Thane", trainerName: "Akash Kumar Jayaswal",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Maharashtra", trainingHub: "Thane",
    totalPax: 0, hoid: "GS20358625", venueName: "Not Available", district: "Thane",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:58:14", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R16", title: "Classroom Training – Andheri", trainerName: "Eric Keki Patel",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Maharashtra", trainingHub: "Mumbai",
    totalPax: 0, hoid: "QS2524671", venueName: "Not Available", district: "Andheri",
    updatedBy: "2002093968", updationOn: "2026-08-19 11:20:56", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R23", title: "Classroom Training – Borivali", trainerName: "Jyotsana Gaurav Tiwari",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Maharashtra", trainingHub: "Mumbai",
    totalPax: 0, hoid: "2004009042", venueName: "Not Available", district: "Borivali",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:34:20", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R39", title: "Classroom Training – Ahmedabad", trainerName: "Tiwari Dharmesh",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Gujarat", trainingHub: "Ahmedabad",
    totalPax: 0, hoid: "2004009044", venueName: "Not Available", district: "Ahmedabad",
    updatedBy: "AGT001", updationOn: "2026-08-19 09:14:35", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R49", title: "Classroom Training – Godhra", trainerName: "Kiritkumar Makwana",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Gujarat", trainingHub: "Godhra",
    totalPax: 0, hoid: "QS3050506", venueName: "Not Available", district: "Godhra",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:48:25", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R70", title: "Classroom Training – Vapi", trainerName: "Pragya Mishra",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Scheduled", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Gujarat", trainingHub: "Vapi",
    totalPax: 0, hoid: "GS20325918", venueName: "Not Available", district: "Vapi",
    updatedBy: "2002093968", updationOn: "2026-08-18 07:36:24", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R96", title: "Classroom Training – Nashik", trainerName: "Mohammad Minhajuddin Mohammad Rafeequddin",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Maharashtra", trainingHub: "Maharashtra",
    totalPax: 0, hoid: "QS2524685", venueName: "Not Available", district: "Nashik",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:24:52", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R107", title: "Classroom Training – Solapur", trainerName: "Mahesh Vishwas Gadgil",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Maharashtra", trainingHub: "Maharashtra",
    totalPax: 0, hoid: "QS2524684", venueName: "Not Available", district: "Solapur",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:45:57", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608R128", title: "Classroom Training – Korba", trainerName: "Dinesh Singh Rathore",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Chhattisgarh", trainingHub: "Chhattisgarh",
    totalPax: 0, hoid: "GS20187880", venueName: "Not Available", district: "Korba",
    updatedBy: "2002093968", updationOn: "2026-08-19 12:49:04", timestamp: "2026-08-10 05:45:23",
  },
  {
    conferenceUid: "CONF2608M6", title: "Classroom Training – Bhubaneswar", trainerName: "Shashi Kumar Choudhary",
    conferenceDate: TODAY_STR, conferenceTime: "09:00", conferenceStatus: "Ongoing", approvalStatus: "Approved",
    location: null, batchSize: null, trainingType: "Classroom Training", state: "Odisha", trainingHub: "Bhubaneswar",
    totalPax: 0, hoid: "QS2524681", venueName: "Not Available", district: "Bhubaneswar",
    updatedBy: "2003198148", updationOn: "2026-08-19 11:50:59", timestamp: "2026-08-10 05:45:23",
  },
];
...
function _makeDemoAttendance(overrides: {
  ...
  const { attendanceId, participantHoId, participantName, phone, location, score, total, lastUpdates } = overrides;
...
export const DEMO_ATTENDANCE_LIST: DemoAttendanceItem[] = [
  _makeDemoAttendance({ attendanceId: "EXATD26081909413949", participantHoId: "EAST105149", participantName: "Ratikanta Samanta", phone: "6295802519", location: "Mecheda", score: 21, total: 30, lastUpdates: "2026-08-19 14:15:38" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909414666", participantHoId: "EASTL62494", participantName: "Surajit Jana", phone: "7059965483", location: "Midnapur City", score: 24, total: 30, lastUpdates: "2026-08-19 14:18:40" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909415294", participantHoId: "EAST114259", participantName: "Kanchan Bhoumik", phone: "7431088361", location: "Daspur", score: 21, total: 30, lastUpdates: "2026-08-19 14:16:13" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909415220", participantHoId: "EAST120900", participantName: "Madhurima Das", phone: "9875587359", location: "Nandigram", score: 28, total: 30, lastUpdates: "2026-08-19 14:15:08" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909415670", participantHoId: "EAST124311", participantName: "Chandam Mondal", phone: "8116207429", location: "Ghatal", score: 17, total: 30, lastUpdates: "2026-08-19 14:19:06" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909415734", participantHoId: "EAST55360", participantName: "Sekh Firojuddin", phone: "7980745702", location: "Howrah", score: 26, total: 30, lastUpdates: "2026-08-19 14:20:19" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909420194", participantHoId: "EAST71502", participantName: "Atanu Khanra", phone: "7430008317", location: "Midnapur City", score: 19, total: 30, lastUpdates: "2026-08-19 14:17:03" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909420327", participantHoId: "EAST22144", participantName: "Surjya Sankar Banerjee", phone: "7076837611", location: "Haldia", score: 26, total: 30, lastUpdates: "2026-08-19 14:22:14" }),
  _makeDemoAttendance({ attendanceId: "EXATD26081909420493", participantHoId: "EAST5093", participantName: "Suman Roy", phone: "8017072818", location: "Howrah", score: 25, total: 30, lastUpdates: "2026-08-19 14:17:30" }),
];
...
const _seedReportParticipants: { name: string; userId: string; checkIn: string; checkOut: string; score: string }[] = [
  { name: "Abhay Kumar Upadhyay", userId: "WEST12590", checkIn: "09:30 AM", checkOut: "11:00 AM", score: "95%" },
  { name: "Ajit Patel",           userId: "WEST12594", checkIn: "09:32 AM", checkOut: "11:02 AM", score: "92%" },
  { name: "Arbaz Altaf",          userId: "WEST12440", checkIn: "09:33 AM", checkOut: "11:02 AM", score: "90%" },
  { name: "Archit Kumar Singh",   userId: "WEST12020", checkIn: "09:34 AM", checkOut: "11:04 AM", score: "90%" },
  { name: "Ashutosh Singh Patel", userId: "WEST12587", checkIn: "09:34 AM", checkOut: "11:05 AM", score: "83%" },
  { name: "Kartik Lakshmikant Vyavhare", userId: "WEST12456", checkIn: "09:38 AM", checkOut: "11:07 AM", score: "74%" },
  { name: "Aditya Kumar Dhir",    userId: "WEST12142", checkIn: "09:40 AM", checkOut: "11:09 AM", score: "81%" },
  { name: "Chirag Sharma Dyervanshi", userId: "WEST12585", checkIn: "09:41 AM", checkOut: "11:14 AM", score: "79%" },
  { name: "Pankaj Kumar Patel",   userId: "WEST12499", checkIn: "09:41 AM", checkOut: "11:14 AM", score: "75%" },
  { name: "Preeti Kashyap Rawat", userId: "WEST12585", checkIn: "09:43 AM", checkOut: "11:15 AM", score: "65%" },
];
...
export const DEMO_SESSION_REPORT_PARTICIPANTS: SessionReportParticipant[] = Array.from(
  { length: SESSION_REPORT_PARTICIPANT_TOTAL },
  (_, i) => {
...
export const DEMO_SESSION_REPORT_SUMMARY = {
  ...
  venueLink: "https://tecsoul.com/meeting/session-window-setup?room=CON-2026-00098&state=UP",
};
