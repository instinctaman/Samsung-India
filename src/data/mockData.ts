...
export const DEMO_AGENDA = [
  {
    ...
    batchSize: "25" as string | null,
    trainingType: "Product Training" as string | null,
    state: "delhi" as string | null,
    trainingHub: "Delhi" as string | null,
  },
  {
    conferenceUid: "demo-conf-uid-sched-1",
    title: "Galaxy AI Features Deep Dive",
    conferenceDate: TOMORROW_STR as string | null,
    conferenceTime: "09:00" as string | null,
    conferenceStatus: "Scheduled",
    approvalStatus: "Approved",
    location: "Samsung Experience Centre, Gurugram" as string | null,
    batchSize: "30" as string | null,
    trainingType: "Classroom Training" as string | null,
    state: "haryana" as string | null,
    trainingHub: "Not Assigned" as string | null,
  },
  {
    conferenceUid: "demo-conf-uid-comp-1",
    title: "Samsung Smart Home Ecosystem",
    conferenceDate: YESTERDAY_STR as string | null,
    conferenceTime: "11:00" as string | null,
    conferenceStatus: "Completed",
    approvalStatus: "Approved",
    location: "Samsung Service Centre, Noida" as string | null,
    batchSize: "20" as string | null,
    trainingType: "Webinar" as string | null,
    state: "up" as string | null,
    trainingHub: "Delhi" as string | null,
  },
  {
    ...
    location: "Samsung Training Hub, Lucknow" as string | null,
    batchSize: "15" as string | null,
    trainingType: "Product Training" as string | null,
    state: "up" as string | null,
    trainingHub: "Not Assigned" as string | null,
  },
