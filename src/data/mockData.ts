...
// Sessions-tab reference set — mirrors the "All Sessions / Today / Completed"
// mockup exactly: one live-now + two scheduled sessions today, and a run of
// completed sessions across the preceding days so the Completed tab isn't empty.
export const DEMO_AGENDA: DemoAgendaItem[] = [
  ...
  },
  {
    ...
    title: "Classroom Training",
    trainerName: "Demo Trainer",
    conferenceDate: _daysFromToday(-2),
    conferenceTime: "16:00",
    conferenceStatus: "Completed",
    approvalStatus: "Approved",
    location: "New Delhi",
  ...
  },
  {
    ...
    title: "Classroom Training",
    trainerName: "Demo Trainer",
    conferenceDate: _daysFromToday(-3),
    conferenceTime: "10:00",
    conferenceStatus: "Completed",
    approvalStatus: "Approved",
    location: "New Delhi",
  ...
  },
  {
    ...
    title: "Classroom Training",
    trainerName: "Demo Trainer",
    conferenceDate: _daysFromToday(-4),
    conferenceTime: "10:00",
    conferenceStatus: "Completed",
    approvalStatus: "Approved",
    location: "New Delhi",
